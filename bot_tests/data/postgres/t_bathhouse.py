...
from wakebot.adapters.postgres import PostgressBathhouseAdapter
from wakebot.entities import Bathhouse, User


class PostgresBathhouseAdapterTestCase(BaseTestCase):
    """PostgresBathhouseAdapter class"""
    def __init__(self):
        super().__init__()
    ...
    def setUp(self):
        self.drop_table()
        self.adapter = PostgressBathhouseAdapter(self.connection)
